...
export const metadata = {
  title: "Financial management | Administrator | SMECC2E",
  description: "SMECC2E administrator financial management.",
};

export default function AdministratorFinancePage() {
  return (
    <Suspense
      fallback={
